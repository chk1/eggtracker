...
<p align="justify">Alle verarbeiteten Daten können mit dem Egg Tracker System in einer <a href="?action=">Kartenansicht</a>, in einer <a href="?action=list_values">Tabelle</a> oder einem <a href="?action=diagram">Diagramm</a> angezeigt werden.
Alle verarbeiteten <a href="?action=list">Datenquellen</a> werden in einer zentralen Tabelle angezeigt.
Ein <a href="?action=export_form">Datenexport</a> ist als XML, CSV oder JSON möglich.</p>
